          ...
          <div className="flex items-center gap-4 mb-12">
            <div className="relative">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-500 to-purple-600 flex items-center justify-center shadow-lg shadow-brand-600/30">
                <Wifi className="w-7 h-7 text-slate-900" />
              </div>
              <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-lg bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center shadow-md">
                <Tv className="w-3 h-3 text-slate-900" />
              </div>
            </div>
            <div>
              ...
              <p className="text-brand-600 text-sm font-semibold">& ANITHA SRIDHAR FIBERNET</p>
            </div>
          </div>

          <div className="mb-8">
            <h2 className="text-4xl font-black text-slate-900 leading-snug mb-3">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-slate-50 relative">
        ...
        >
          ...
          <div className="flex lg:hidden items-center gap-3 mb-8">
            ...
            <div>
              <p className="text-sm font-extrabold text-slate-900 leading-tight">ASHA CABLE & ANITHA SRIDHAR FIBERNET</p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-600/15 border border-brand-600/25 mb-4">
              ...
              <span className="text-xs text-brand-700 font-medium">Admin Portal</span>
            </div>
            <h2 className="text-3xl font-black text-slate-900 mb-1.5">Sign In</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 rounded-xl px-4 py-3.5 pl-[52px] text-slate-900 text-sm placeholder-slate-400 outline-none transition-all duration-200"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 rounded-xl px-4 py-3.5 pl-[52px] pr-12 text-slate-900 text-sm placeholder-slate-400 outline-none transition-all duration-200"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            <p className="text-xs text-slate-500 text-center">
              Default: <span className="text-slate-600">admin@ashacable.com</span> ·{" "}
              <span className="text-slate-600">Admin@1234</span>
            </p>
          </div>
        </motion.div>
      </div>
